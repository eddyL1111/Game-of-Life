...
import lifeGame.ui.World;

/**
 * Calculates the size of the screen and initializes the game frame. 
...
{
	/** Represents the toolkit for the GUI. **/
    ...
    /**
     * Calculates the position of the centre of the screen.
     * 
     ...
     * 
     * @param widthPercent Percent of the width
     * @param heightPercent Percent of the height
